...
// never drift from the manuscript again.
const BOOK_STATS = [
  { key: "chapters", n: "20", label: "chapters", icon: "book-nav" },
  { key: "words", n: "124k", label: "words", icon: "note-nav" },
  { key: "figures", n: "48", label: "charts & figures", icon: "growth-nav" },
  { key: "receipts", n: "60", label: "tracked receipts", icon: "journal-nav" },
  { key: "links", n: "161", label: "linked sources", icon: "portal-nav" },
  { key: "glossary", n: "45", label: "glossary terms", icon: "chest-nav" },
];

const DEVICE_STATS = [
  { key: "goblinChecks", n: "26", label: "Goblin Checks", icon: "check-nav" },
  { key: "goblinTraps", n: "20", label: "Goblin Traps", icon: "trap-nav" },
  { key: "goblinFacts", n: "20", label: "Goblin Facts", icon: "potion-nav" },
  { key: "alignments", n: "20", label: "Alignments", icon: "guide-nav" },
  { key: "examples", n: "20", label: "Examples", icon: "examples-nav" },
];
