...
export const TOPICS: Record<string, Topic> = {
  ...
  "copyright": { chapter: 11, title: "AI, Copyright & Creators in Canada", blurb: "The Canadian newspapers’ case against OpenAI, the Geist/Craig vs TWUC/ACTRA contest, and likeness rights." },
  "deepfakes": { chapter: 12, title: "Deepfakes & Misinformation", blurb: "What the 2025 Canadian election data actually showed, the Bill C-16 gap, and the international comparison." },
  ...
  "labour": { chapter: 14, title: "AI, Jobs & the Canadian Economy", blurb: "What the evidence shows, what Acemoglu and Autor disagree about, and the Canadian empirical baseline." },
  "governance": { chapter: 15, title: "How AI Is Governed in Canada", blurb: "The post-AIDA institutional reality: who regulates what across federal, provincial, and sectoral layers." },
};
